				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="usuario_rfc_reg" id="usuario_rfc" maxlength="20" required="" >
						</div>
					</div>
					...
					<div class="col-12">
						...
						<div class="form-group">
							<select class="form-control" name="usuario_privilegio_reg">
								...
								<option value="2">Supervisor: Algunos privilegios</option>
								<option value="3">Empleado: Ningun Privilegio</option>
							</select>
						</div>
					</div>
				</div>
