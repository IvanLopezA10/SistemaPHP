<?php
	if ($lc->encryption($_SESSION['id_sistema']) != $pagina[1]) {
...
<div class="container-fluid">
	...
	<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php" method="POST" data-form="update" autocomplete="off">
				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="usuario_rfc_up" id="usuario_rfc" maxlength="20" value="<?php echo $campos['usuario_rfc']; ?>">
						</div>
					</div>
					...
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="usuario_nombre_up" id="usuario_nombre" maxlength="35" value="<?php echo $campos['usuario_nombre']; ?>">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
							<label for="usuario_apellido" class="bmd-label-floating">Apellidos</label>
							<input type="text" class="form-control" name="usuario_apellido_up" id="usuario_apellido" maxlength="35" value="<?php echo $campos['usuario_apellido']; ?>">
						</div>
					</div>
		...
		<fieldset>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<?php if ($_SESSION['privilegio_sistema'] == 1 && $campos['usuario_id'] != 1 ) { ?>
					<div class="col-12">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="password" class="form-control" name="clave_admin" id="clave_admin" pattern="[a-zA-Z0-9$@.-]{5,100}" maxlength="100" required="">
						</div>
					</div>
				</div>
			</div>
		...
		<?php if($lc->encryption($_SESSION['id_sistema']) != $pagina[1]){ ?>
